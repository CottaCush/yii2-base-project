...
App.Widgets.NewInvite = (function ($, document, ModalComponent) {
    var pub = {
        ...
        formCallbacks: function () {
            var form = this.$form = this.$inputWrap.closest('form');
            form.on(this.events.submit, function () {
                var isInputValid = pub.validateInput(),
        ...
        modalCallbacks: function () {
            var modal = this.$inputWrap.closest('.modal');
        ...
        setInitialDropdownMenuItem: function () {
            ...
            var item = this.$dropdownMenu.find('li').filter(function () {
        ...
        validateTags: function () {
            var length = this.getInviteTags().length;
